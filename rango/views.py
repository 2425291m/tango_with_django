...
def show_category(request, category_name_slug):
    ...
    try:
        ...
        # Note that filter() qill return a list of page objects or an empty list
...
def register(request):
    ...
    if request.method == 'POST':
        ...
        if user_form.is_valid() and profile_form.is_valid():
            ...
            # until we're ready to avoid inegrity problems
        ...
        # not a HTTPS POST< so we render our form using two ModelForm instances
